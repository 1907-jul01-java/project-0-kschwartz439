    ...
    public void menu(){
        ...
        switch (answer){
            ...
            case "1": try (PreparedStatement empStatement = connection.prepareStatement("SELECT * FROM users WHERE access = ?")) {
                empStatement.setString(1, "admin");
                    ...
                    if (answer3.equals(empResult.getString("id"))){
                        ...
                        while (answer2!=null){
                            ...
                            while (answer2!=null){
                                ...
                                answer2 = scanner.next();
                                while (!answer2.equals("employee") || !answer2.equals("customer") || !answer2.equals("break") || !answer2.equals("admin")){
                                ...
                                switch (answer2){
                                    ...
                                    case "admin": try (PreparedStatement adStatement = connection.prepareStatement("UPDATE access VALUE FROM users WHERE id = ?")){
                                        adStatement.setString(1, "admin");
                                        adStatement.setString(2, accId);
                                        adStatement.executeUpdate();
                                    }
                                    catch (SQLException e){
                                        e.getMessage();
                                    }
                    ...
                    if (answer.equals(empResult.getString("id"))){
                        ...
                        while (answer2!=null){
                            ...
                            while (answer2!=null){
                                ...
                                System.out.println("Please enter the access level for this account or enter 'delete' to delete the account.");
                                answer2 = scanner.next();
                                while (!answer2.equals("employee") || !answer2.equals("customer") || !answer2.equals("delete") || !answer2.equals("admin")){
                                    System.out.println("Please enter a valid option and try again.");
                                    answer2 = scanner.next();
                                }
                                switch (answer2){
                                    case "employee": try (PreparedStatement emp2Statment = connection.prepareStatement("UPDATE (firstName, lastName, access) VALUES FROM users")) {
                                        emp2Statment.setString(1, firstName);
                                        emp2Statment.setString(2, lastName);
                                        emp2Statment.setString(3, answer2);
                                        emp2Statment.executeUpdate();
                                        ...
                                        break;
                                    case "customer": try (PreparedStatement emp2Statement = connection.prepareStatement("UPDATE (firstName, lastName, access) VALUES FROM users")) {
                                        emp2Statement.setString(1, firstName);
                                        emp2Statement.setString(2, lastName);
                                        emp2Statement.setString(3, answer2);
                                        emp2Statement.executeUpdate();
            ...
            case "3": try (PreparedStatement empStatement = connection.prepareStatement("SELECT * FROM users WHERE access = ?")) {
            ...
            case "4": System.out.println("Please enter the ID of the user whose accounts you want to edit.\n");
            answer2 = scanner.next();
